//
//  BMKBaiduMapWalkNavigationPage.m
//  IphoneMapSdkDemo
//
...
#import "BMKBaiduMapWalkNavigationPage.h"

//开发者通过此delegate获取mapView的回调方法
@interface BMKBaiduMapWalkNavigationPage ()<BMKMapViewDelegate>
@property (nonatomic, strong) BMKMapView *mapView; //当前界面的mapView
@end

@implementation BMKBaiduMapWalkNavigationPage
...
- (void)viewDidLoad {
    ...
    [self configUI];
    [self createMapView];
    [self openBaiduMapWalkNavigation];
}
...
- (void)openBaiduMapWalkNavigation {
    //初始化调启导航时的参数管理类
