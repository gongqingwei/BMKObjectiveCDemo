...
#import "BMKPinAnnotationPage.h"

//复用annotationView的指定唯一标识
static NSString *annotationViewIdentifier = @"com.Baidu.BMKPinAnnotation";

//开发者通过此delegate获取mapView的回调方法
@interface BMKPinAnnotationPage ()<BMKMapViewDelegate>
@property (nonatomic, strong) BMKMapView *mapView; //当前界面的mapView
@property (nonatomic, strong) BMKPointAnnotation *annotation; //当前界面的标注
@end

@implementation BMKPinAnnotationPage
...
- (void)createAnnotation {
     ...
     */
    _annotation.screenPointToLock = CGPointMake(100, 100);
    //设置标注的标题
    _annotation.title = @"标注";
    //副标题
    _annotation.subtitle = @"固定屏幕";
    /**
